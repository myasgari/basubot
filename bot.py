...
QUESTIONS = {
    ...
    "q8": {
        ...
        "answer": (
            ...
            "(به جای XXXXXX کد استادی خود را وارد کنید)\n\n"
            "نام کاربری: کد استادی\n"
            "رمز عبور: کد ملی + v\n"
            "مثال: 1234567890v\n\n"
            "اگر وارد نشد:\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
         "برای مشاهده سوالات متداول، از گزینه «📋 سوالات» استفاده کنید. اگر سوال شما موجود نبود نبود، با پشتیبانی دانشگاه تماس بگیرید: 📞 31401542-081",
        reply_markup=main_menu
    )
